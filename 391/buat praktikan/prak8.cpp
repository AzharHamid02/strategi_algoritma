...
int main(int argc, char** argv)
{
	...
	graph.setNumLevels(10);
	graph.setNumNodes(10);
	
	// tambahkan node
	graph.addNode(0, 2, 1.0f);
	graph.addNode(0, 3, 1.2f);
	graph.addNode(0, 5, 1.0f);
	graph.addNode(1, 4, 1.2f);
	graph.addNode(1, 6, 1.2f);
	graph.addNode(1, 3, 1.2f);
	graph.addNode(2, 0, 1.0f);
	graph.addNode(2, 4, 1.2f);
	graph.addNode(2, 7, 1.2f);
	graph.addNode(3, 1, 5.0f);
	graph.addNode(3, 0, 5.0f);
	graph.addNode(3, 8, 5.0f);
	graph.addNode(4, 9, 0.5f);
	graph.addNode(4, 1, 0.5f);
	graph.addNode(4, 2, 0.5f);
	graph.addNode(5, 9, 1.0f);
	graph.addNode(5, 6, 1.0f);
	graph.addNode(5, 0, 1.0f);
	graph.addNode(6, 5, 8.0f);
	graph.addNode(6, 7, 8.0f);
	graph.addNode(6, 1, 8.0f);
	graph.addNode(7, 6, 1.0f);
	graph.addNode(7, 2, 8.0f);
	graph.addNode(7, 8, 8.0f);
	graph.addNode(8, 7, 2.0f);
	graph.addNode(8, 9, 2.0f);
	graph.addNode(8, 3, 2.0f);
	graph.addNode(9, 5, 0.5f);
	
	
	// tambahkan edge dengan jarak
	graph.addEdge(4, 1, 1.0f);
	graph.addEdge(0, 2, 10.0f);
	graph.addEdge(9, 0, 5.0f);
	graph.addEdge(1, 3, 9.0f);
	graph.addEdge(1, 4, 8.0f);
	graph.addEdge(4, 2, 5.0f);
	graph.addEdge(4, 1, 5.0f);
	graph.addEdge(2, 0, 1.0f);
	graph.addEdge(2, 4, 2.0f);
	graph.addEdge(3, 8, 10.0f);
	graph.addEdge(8, 7, 5.0f);
	graph.addEdge(7, 6, 5.0f);
	graph.addEdge(6, 5, 10.0f);
	graph.addEdge(5, 9, 15.0f);
